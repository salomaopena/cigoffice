    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-12 p-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="text_name" id="text_name" value="<?= old('text_name') ?>" class="form-control" placeholder="Nome do produto">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="text_description" id="text_description" value="<?= old('text_description') ?>" class="form-control" placeholder="Descrição do produto">
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="mb-3">
                        ...
                        <input list="list_categories" name="text_category" id="text_category" class="form-control" value="<?= old('text_category') ?>" placeholder="Categoria">
                ...
                <div class="col-lg-6 col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" name="text_price" id="text_price" value="<?= old('text_price') ?>" class="form-control" placeholder="Preço">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_promotion" id="text_promotion" value="<?= old('text_promotion') ?>" class="form-control" placeholder="Promoção">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_initial_stock" value="<?= old('text_initial_stock') ?>" id="text_initial_stock" class="form-control" placeholder="Estoque inicial">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_stock_minimum_limit" id="text_stock_minimum_limit" class="form-control" value="<?= old('text_stock_minimum_limit') ?>" placeholder="Limite mínimo de estoque">
